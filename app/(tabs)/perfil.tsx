...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 17, fontWeight: "900", color: Colors.dark },
  ...
  pedidoSub: { fontSize: 11, color: Colors.gray },
  ...
  optionText: { flex: 1, fontSize: 14, fontWeight: "500", color: Colors.dark },
  optionArrow: { fontSize: 20, color: "#ccc" },
  optionDivider: { height: 1, backgroundColor: "#f5f5f5", marginLeft: 56 },
  logoutBtn: {
    backgroundColor: "white",
    borderRadius: 16,
    paddingVertical: 15,
