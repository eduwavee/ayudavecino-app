...
const getStyles = (tema: TemaTokens) => StyleSheet.create({
  ...
  filtroBadgeText:  { color:'white', fontSize:9, fontWeight:'900' },
  serviceDist:      { fontSize:10, fontWeight:'600', color:tema.subTexto },
  ...
  panelTitulo:      { fontSize:20, fontWeight:'900', color:tema.texto, marginBottom:16 },
  panelLabel:       { fontSize:11, fontWeight:'700', color:tema.subTexto, letterSpacing:1.2, marginBottom:8 },
  ...
  chipText:         { fontSize:12, fontWeight:'600', color:tema.subTexto },
  chipTextActivo:   { color:'white' },
  precioRow:        { flexDirection:'row', alignItems:'center', gap:10, marginBottom:18 },
  precioInput:      { flex:1, backgroundColor:tema.inputBg, borderRadius:12, paddingHorizontal:14, paddingVertical:10, fontSize:14, color:tema.texto },
  ...
  switchLabel:      { fontSize:14, fontWeight:'600', color:tema.texto },
  ...
  btnLimpiarText:   { fontSize:14, fontWeight:'700', color:tema.texto },
  btnAplicar:       { flex:2, paddingVertical:14, borderRadius:14, backgroundColor:Colors.dark, alignItems:'center' },
  btnAplicarText:   { fontSize:14, fontWeight:'700', color:'white' },
